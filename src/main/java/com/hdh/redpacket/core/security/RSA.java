...
//        generateKeyPair(RSAKeyStore);
//        KeyPair keyPair = getKeyPair(RSAKeyStore);
//        String src = "hellojava";
//        byte[] before = encrypt(keyPair.getPublic(),src.getBytes());
//        String encrypt = new String(before);
//        System.out.println("加密后:"+ encrypt);
//
//        byte[] after = decrypt(keyPair.getPrivate(),before);
//        String decrypt = new String(after);
